...
$(function () {
    ...
    $(".introductionButton").on('click', function () {
        $('#id2').fadeOut(250);
        $('#id3').fadeIn(200);
        picWidth = $(".pic1")[0].offsetWidth;
        picHeight = $(".pic1")[0].offsetHeight;
    ...
    //             if(tempx < 0 ){
    //                 tempx = 0;
    //             } else if(tempx > picWidth){
    //                 tempx = picWidth
    //             }
    //             if(tempy <0 ){
    //                 tempy = 0;
    //             } else if(tempy > picHeight){
    //                 tempy = picHeight;
    //             }
    ...
    //         for(let m = 0 ; m < pices.length ; m++){
    //             if(Math.abs(pices[m].offsetLeft - x)<=picWidth/2 && Math.abs(pices[m].offsetTop - y )<=picHeight/2 && pices[m]!=obj){
    //                 return pices[m];
    //             }
    //         }
    //         return obj;
    ...
    //         for(let s = 0 ; s < 20;s++){
    //             let element1 = pices[Math.floor(Math.random()*4)];
    //             let element2 = pices[Math.floor(Math.random()*4)];
    ...
    //         let tempPices = document.querySelectorAll('.pic');
    //         let strTemp = '';
...
module.exports.initsb = initPuzzle;
